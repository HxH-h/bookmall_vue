  ...
  <div style=" 
    ...
    >
      <el-menu-item style="width: 5vw;margin-left: 10vw">
        <img
          style="width: 5vw; background-color: transparent ;"
      ...
      <el-menu-item index="1" style="margin-left: 3svw;color: black" @click="jumpPage('book')">图书管理</el-menu-item>
      <el-menu-item index="2" style="margin-left: 3svw;color: black" @click="jumpPage('RankList')">订单管理</el-menu-item>
      <el-menu-item index="2" style="margin-left: 3svw;color: black" @click="jumpPage('RankList')">数据统计</el-menu-item>
      <div class="flex-grow" />
